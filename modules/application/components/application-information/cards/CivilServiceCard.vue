<template>
	<v-row>
		<v-col cols="12">
			<p>IV. Civil Service Eligibility</p>
			<v-card class="pa-5">
				<v-row class="pt-2" v-for="(form, formIndex) in civilServices" :key="formIndex">
					...
					<v-col class="py-0 pl-1 pt-md-9" cols="12" md="6">
						<v-row>
							<v-col class="py-0 pl-1" v-for="(info, index) in form.civilService.info" :key="index" cols="12">
					...
					<v-col v-if="formIndex === civilServices.length - 1" class="py-0 pl-1" cols="12">
